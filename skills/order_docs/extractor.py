...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
#  内訳書データ抽出 (extract_nairaku_data 本体)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# テキスト判定 (_NAIRAKU_*_KEYWORDS, _is_subtotal_text, _is_footer_terminator)
# は `nairaku_text_utils.py`、補助ヘルパ (_detect_header_end_row,
# _build_merged_cells_cache, _resolve_col_spans 等) は
# `nairaku_extraction.py` に分離済み。このモジュールでは
# extract_nairaku_data 本体および apply_nairaku_page_padding を担当する。
